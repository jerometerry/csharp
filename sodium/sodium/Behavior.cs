namespace sodium
{
    ...
    public class Behavior<TBehavior> : IDisposable
    {
        ...
        public Behavior<TResult> Lift<TNewBehavior, TResult>(
            IBinaryFunction<TBehavior, TNewBehavior, TResultftFunction, 
            Behavior<TBehavior2> behavior)
        {
            var behaviorLifter = new BehaviorLifter2<TBehavior, TBehavior2, TResultBTResultnction);
        ...
        public Behavior<TResult> Lift<TBehavior2, TBehavior3, TResult>(
            ITernaryFunction<TBehavior, TBehavior2, TBehavior3, TResult> behaviorFuf      Behavior<TBehavior2> behavior2, 
            Behavior<TBehavior3> behavior3)
        {
            var behaviorLifter = new BehaviorLifter3<TBehavior, TBehavior2, TBehavior3, TResult>(behaviorFufvar mapFunction = Map(behaviorLifter);
            var behaviorFubehaviorFunction = Behavior<TBehavior2>.Apply(mapFunction, behavior2);
            return Behavior<TBehavior3>.Apply(behaviorFunction3);
        }

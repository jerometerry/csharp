namespace sodium
{
    public class ApplyBehaviorEventSinkSender<TA, TB> : IHandler<Transaction>
    {
        ...
        public ApplyBehaviorEventSinkSender(EventSink<TB> o, Behavior<ILambda1<TA, TB>> bf, Behavior<TA> ba, BehaviorPrioritizedInvoker<TA, TB> behaviorPrioritizedInvoker)
        {
            _o = o;
            _bf = bf;
            _ba = ba;
